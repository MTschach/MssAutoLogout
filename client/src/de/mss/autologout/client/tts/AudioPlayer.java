package de.mss.autologout.client.tts;
...
public class AudioPlayer extends Thread {
   ...
   public void setGain(float fGain) {
      ...
      if (this.line != null && this.line.isControlSupported(FloatControl.Type.MASTER_GAIN)) {
         ((FloatControl)this.line.getControl(FloatControl.Type.MASTER_GAIN)).setValue((float)(20 * Math.log10(fGain <= 0.0 ? 0.0000 : fGain)));
   ...
   public void run() {
      ...
      if (audioFormat.getChannels() == 1) {
         ...
         if (this.outputMode == 0) {
            ...
            assert this.outputMode == 3 : "Unexpected output mode: " + this.outputMode;
         }
      }
