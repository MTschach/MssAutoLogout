...
public class ErrorCodes implements Serializable {
   ...
   public static final Error ERROR_USER_ALREADY_EXISTS       = new Error(ERROR_CODE_BASE + 4, "user already ixists");
   public static final Error ERROR_INVALID_USER              = new Error(ERROR_CODE_BASE + 5, "user is invalid");
   public static final Error ERROR_DELETE_USER               = new Error(ERROR_CODE_BASE + 6, "could not delete user");
