...
public class AutoLogoutListener implements Runnable {
   ...
   private AutoLogout autoLogout = null;


   public AutoLogoutListener(AutoLogout a) {
      this.autoLogout = a;
   }
   ...
   public void run() {
      ...
      BigInteger port = cfgFile.getValue(AutoLogout.CFG_KEY_BASE + ".listen.port", BigInteger.valueOf(31002));
      String bindIp = cfgFile.getValue(AutoLogout.CFG_KEY_BASE + ".listen.ip", "localhost");
